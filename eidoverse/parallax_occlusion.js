import { Break, Fn, If, Loop, abs, clamp, dFdx, dFdy, dot, float, max, min, mix, normalViewGeometry, normalize, positionViewDirection, tangentGeometry, tangentView, texture, textureLevel, uv, vec2, vec3 } from 'npm:three@0.184.0/tsl';
