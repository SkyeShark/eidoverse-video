...
const HELPER_MODULES = [
    ...
    'eidoverse/dismember.js',             // globalThis.makeDismemberment — per-limb health (Fallout-style cripple/sever rules) + programmatic VRM dismemberment: skinned split at humanoid joints, procedural flesh stump caps, arterial spurt + ground stains + spreading pool, severed pieces tumble rigid; works on any VRM humanoid
    'eidoverse/vegetation_loader.js',     // globalThis.createFlora — the VEGETATION BRUSH: asset-driven species (grass/galleta_dry/grass_tuft/blackbrush/creosote/sagebrush/yucca/corn), seasonal color, height+wind coupling, organic/row planting, surface raycast placement, cross-field occupancy, character pushers
    ...
    'eidoverse/captions.js',            // globalThis.makeCaptions — word-timed broadcast captions on the overlay layer (TikTok-style pages, active-word highlight, style overridable)
