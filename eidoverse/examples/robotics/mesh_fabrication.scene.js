// Carve an ordinary Object3D assembly. Replace source with a loaded model.
...
globalThis.setup = async function () {
  ...
  const {manufacturingSample}=await import(EIDOVERSE_DIR+"robotics/manufacturing_samples.js");
  const source=manufacturingSample("handle");
  job = fab.rotaryCarve(machine, source, {
    renderer: _r,
    material: "wood",
    duration: 28,
  });
