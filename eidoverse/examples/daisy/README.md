...
[Voice synthesis guide](../../../docs/voicebox.md) · [Music synthesis guide](../../../docs/synthkit.md)
...
generative audio model. [voicebox](../../../docs/voicebox.md) sings every vocal: each verse
...
[synthkit](../../../docs/synthkit.md) plays the band, and the master bus
...
expression path for other VRMs; see the [characters guide](../../../AGENTS.md).
