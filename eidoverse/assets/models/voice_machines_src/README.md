...
[Pack README](../voice_machines/README.md) · [Sources](../voice_machines/SOURCES.md) · [Blender guide](../../../../docs/blender.md) · [Props and sets guide](../../../../docs/props-and-sets.md)
...
- `run_blender.sh` is the isolated headless runner (see the
  [Blender guide](../../../../docs/blender.md)). Never start
